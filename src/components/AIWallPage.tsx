...
export function AIWallPage() {
  ...
  return (
    <div className="min-h-screen bg-[#003d82] flex flex-col items-center justify-center px-4 py-20 relative overflow-hidden">
      {/* Back button */}
      <motion.a
        href="/"
        onClick={(e) => {
        ...
        {!submitted ? (
          ...
          >
            ...
            >
              ...
              {error && (
                <p className="text-[#E30613] text-sm">{error}</p>
              )}
